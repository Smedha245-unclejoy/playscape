...
class UserSerializer(serializers.ModelSerializer):
    ...
    prefered_radius = serializers.IntegerField(source='profile.prefered_radius')
    ...
    def get_last_location(self, obj):
        pnt = fromstr(obj['last_location'])
        obj['last_location'] = {'longitude': pnt.coords[0], 'latitude': pnt.coords[1]}
        return ret
